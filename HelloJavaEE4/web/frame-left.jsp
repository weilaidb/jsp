...
<%--&lt;%&ndash;    <a href="sql_bin/insertdb.jsp"  target="frame_right">输入数据(mysql bin)</a></p>&ndash;%&gt;--%>
<%--&lt;%&ndash;    <a href="login_bin/login.jsp"   target="frame_right">记 事 本(mysql) bin</a></p>&ndash;%&gt;--%>
