...
<%--        <input type="button" value="查看" onclick="showFile()" />--%>
        <br>
        <textarea name="filetip" style="width: 35%;height: 100%;background-color: #cce8cf;"><%=contentTips%></textarea>
        <textarea name="filebf"  style="width: 15%;height: 100%;background-color: #cce8cf;"><%=contentBf%></textarea>
        <textarea name="fileaf"  style="width: 45%;height: 100%;background-color: #cce8cf;"><%=contentAf%></textarea>
    </form>
</font>
