...
//    @Test
    ...
    public static String gbk2utf8(String code) {
        try {
    ...
    /**
     * 查看原有文件的编码格式，使用notepad++，在右下角会显示
     * @param code
     * @return
     */
    public static String utf8togbk(String code) {
        try {
    ...
    public static String utf8tounicode(String code) {
        try {
            return new String(code.getBytes("utf-8"), "unicode");
        } catch (UnsupportedEncodingException e) {
            e.printStackTrace();
        }
        return "";
...
//    public static String gb2312toutf8(String code) {
//        try {
//            return new String(code.getBytes("gb2312"), "utf-8");
//        } catch (UnsupportedEncodingException e) {
//            e.printStackTrace();
//        }
//        return "";
